...
async def transcribe_voice(bot, file_id: str) -> str:
    ...
    try:
        ...
        parts = [
            types.Part(
                text="Transcribe this audio to text exactly as spoken. Do not add any markdown or explanations."
            ),
            types.Part(inline_data=types.Blob(data=file_bytes, mime_type="audio/ogg")),
        ]
